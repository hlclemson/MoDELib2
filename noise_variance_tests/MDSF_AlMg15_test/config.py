...
files_to_copy_from_lib = {
    ...
    'correlation_file_md_sf': Path(f'../../Library/GlidePlaneNoise/AlMg15_Cx_R100_ISF.vtk'),
    ...
    'material_file': Path('../../Library/Materials/AlMg15.txt'),
...
DD_parameters = {
    ...
    'Nsteps': '5001', # number of simulation steps
...
MDStackingFault_parameters = {
    ...
    'correlationFile': Path('./AlMg15_Cx_R100_ISF.vtk'),
...
Polycrystal_parameters= {
    ...
    #'boxScaling': np.array([1020, 109, 3800]),
