...
files_to_copy_from_lib = {
    ...
    'correlation_file_md_ss_xz': Path(f'../../Library/GlidePlaneNoise/MoDELCompatible_FeCr12_xz.vtk'),
    'correlation_file_md_ss_yz': Path(f'../../Library/GlidePlaneNoise/MoDELCompatible_FeCr12_yz.vtk'),
...
MDSolidSolution_parameters = {
    ...
    'correlationFile_xz': Path('./MoDELCompatible_FeCr12_xz.vtk'),
    'correlationFile_yz': Path('./MoDELCompatible_FeCr12_yz.vtk'),
    # Vector parameters with comments (use setInputVector)
