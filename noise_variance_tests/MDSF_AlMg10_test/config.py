...
files_to_copy_from_lib = {
    ...
    'correlation_file_md_sf': Path(f'../../Library/GlidePlaneNoise/AlMg10_Cx_R100_ISF.vtk'),
    ...
    'material_file': Path('../../Library/Materials/AlMg10.txt'),
...
MDStackingFault_parameters = {
    ...
    'correlationFile': Path('./AlMg10_Cx_R100_ISF.vtk'),
