...
files_to_copy_from_lib = {
    ...
    'correlation_file_md_ss_xz': Path(f'../../Library/GlidePlaneNoise/MoDELCompatible_FeCr10_xz.vtk'),
    'correlation_file_md_ss_yz': Path(f'../../Library/GlidePlaneNoise/MoDELCompatible_FeCr10_yz.vtk'),
...
MDSolidSolution_parameters = {
    ...
    'correlationFile_xz': Path('./MoDELCompatible_FeCr10_xz.vtk'),
    'correlationFile_yz': Path('./MoDELCompatible_FeCr10_yz.vtk'),
    # Vector parameters with comments (use setInputVector)
