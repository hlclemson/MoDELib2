...
files_to_copy_from_lib = {
    ...
    'correlation_file_md_sf': Path(f'../../Library/GlidePlaneNoise/NiCoCr1350_Cx_R132_ISF.vtk'),
    #'correlation_file_md_ss_xz': Path(f'../../Library/GlidePlaneNoise/AlMg5_Cx_R100_ISF.vtk'),
    #'correlation_file_md_ss_yz': Path(f'../../Library/GlidePlaneNoise/MoDELCompatible_FeCr8_yz.vtk'),
    'material_file': Path('../../Library/Materials/NiCoCr1350K.txt'),
...
DD_parameters = {
    ...
    'Nsteps': '6001', # number of simulation steps
...
MDStackingFault_parameters = {
    ...
    'correlationFile': Path('./NiCoCr1350_Cx_R132_ISF.vtk'),
