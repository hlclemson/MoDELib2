...
# set plot properties
    ...
    #data = np.loadtxt('./ensembledCorrelation.txt')
    #data = np.loadtxt('./ensembledCorrelationR10.txt')
    data = np.loadtxt('./ensembledCorrelationR100.txt')
    #data = np.loadtxt('./ensembledCorrelationR1000.txt')
...
# Save figure 
    figName = "ensembledCorrelation.png"
