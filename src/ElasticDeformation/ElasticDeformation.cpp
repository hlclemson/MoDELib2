...
template<int dim>
typename ElasticDeformation<dim>::VectorDim ElasticDeformation<dim>::displacement(const VectorDim& x,
                                                                                  const NodeType* const node,
                                                                                  const ElementType* const ele,
                                                                                  const SimplexDim* const guess) const
{
  if(uniformLoadController)
  {
...
template<int dim>
typename ElasticDeformation<dim>::MatrixDim ElasticDeformation<dim>::stress(const VectorDim& x,
                                                                            const NodeType* const node,
                                                                            const ElementType* const ele,
                                                                            const SimplexDim* const guess) const
{
...
template<int dim>
typename ElasticDeformation<dim>::VectorMSize ElasticDeformation<dim>::mobileConcentration(const VectorDim&,
                                                                                           const NodeType* const,
                                                                                           const ElementType* const,
                                                                                           const SimplexDim* const) const
{
