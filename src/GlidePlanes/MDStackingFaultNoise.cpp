...
MDStackingFaultNoise::MDStackingFaultNoise(const PolycrystallineMaterialBase& mat,
  ...
  /* init */ GlidePlaneNoiseBase<1>("MDStackingFaultNoise"+tag,displacementAngle*M_PI/180.0,seed,gridSize,gridSpacing,nonOrthogonalBasisReader(correlationFile_in))
