...
AnalyticalSolidSolutionNoise::AnalyticalSolidSolutionNoise(const std::string& type,
                                                           ...
                                                           const double& MSSS) :
  /* init */ GlidePlaneNoiseBase<2>(type,"AnalyticalSolidSolutionNoise"+tag,seed,gridSize,gridSpacing,latticeBasis)
  /* init */,a(a_in)
  /* init */,a_cai(a_Cai_in)
