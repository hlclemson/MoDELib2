...
namespace model
{
    struct SlipSystem : public StaticID<SlipSystem>
    {
        ...
        std::tuple<Eigen::Matrix<double,3,3>,double,double,double,double> gridInterp(const VectorDim& x) const;
        std::tuple<Eigen::Matrix<double,3,3>,double,double,double,double> gridVal(const Eigen::Array<int,2,1>& idx) const;
    };
}
#endif
