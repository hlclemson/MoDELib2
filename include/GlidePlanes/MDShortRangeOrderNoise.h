...
#ifndef model_MDShortRangeOrderNoise_h
#define model_MDShortRangeOrderNoise_h
...
namespace model
{
    struct MDShortRangeOrderNoise : public GlidePlaneNoiseBase<1>
    {
        ...
        MDShortRangeOrderNoise(const PolycrystallineMaterialBase& mat,
        ...
        void ShortRangeOrderCorrelationReader(const std::string& fileName_vtk, REAL_SCALAR* Rr, const int& NR);
